...
14. Once you are satisfied with the question, be sure to delete the solution from `question.html`. Then, commit and push your changes. Now, your questions should be synced to the remote repository and available on the online PrairieLearn course site!